'use client'; // This directive is crucial for using client-side hooks like useState, ChangeEvent, FormEvent

import React, { useState, ChangeEvent, FormEvent } from "react";
import { ChevronDown, Send } from "lucide-react"; // Lucide icons are often client-side
import client from "../../client"; // Import the Sanity client for form submission
import Image from "next/image";

// Define interfaces for data passed as props and for form state
...
interface ContactFormClientProps {
    pageData: PageDataProps; // Receive the static page data as props
}
